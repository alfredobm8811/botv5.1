...
def onmessage(update,bot:ObigramClient):
    try:
        ...
        if '/start' in msgText:
            start_msg = '⚜️Bienvenido A MegaSpaceBot⚜️\n\n'
            start_msg+= '                       ⚙️ Configure el Bot ⚙️\n'
            start_msg+= '/info 👈 Información de la cuenta \n' 
            start_msg+= '/tutorial 📋 Aprende a como utilizar el bot\n' 
...
def main():
    bot_token = os.environ.get('bot_token')
    #set in debug
    bot_token = '5159576206:AAG7qOs2vxhTW5CeRAhlgA7OvwLQ-ykYUI8'
